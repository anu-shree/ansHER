...
user7.save!
user8 = User.create!(first_name: 'Anupriya', last_name: 'Shree', email: 'anupriyashree34@gmail.com', description: 'Student||Sophomore||IITian', password: '12345', unread_messages: 5)
